...
def _sm(pred_lat_acc: float, n: int = 33, curvature: float = 0.0):
  # orientationRate.z * velocity.x == pred_lat_acc for every sample
  z = [pred_lat_acc] * n
  x = [1.0] * n
  return {
...
def test_disabled_until_long_enabled():
...
if __name__ == "__main__":
  test_disabled_until_long_enabled()
  test_enters_on_predicted_lat_acc()
  print("ok")
